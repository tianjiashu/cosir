...
- Name: frontend-regressions.spec.ts >> 工具追踪视觉回归：Reasoning 和工具组都有图标且完成后收起
- Location: tests\e2e\frontend-regressions.spec.ts:24:5
...
Locator: locator('[data-role="assistant"]').last().getByText('Reasoning', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-role="assistant"]').last().getByText('Reasoning', { exact: true })
...
- complementary:
  ...
  - navigation "工作区任务列表":
    ...
    - button "demo 1"
    - button "更多 demo 操作"
    - button "工具追踪视觉回归 1/1/2026"
    - button "更多 工具追踪视觉回归 操作"
- main:
  - paragraph: 对话
  - paragraph: 已存在任务
  - text: demo
