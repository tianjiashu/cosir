...
`src-tauri/resources/terminal-worker/`; Tauri then copies that directory into the
application resources. `npm run test:terminal-worker-bundle` verifies the staged or
